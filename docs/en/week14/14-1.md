...
Figure 4. Top: A log domain factor graph. The energy is a sum of factors that take different subsets of variables as inputs. Bottom: Each possible configuration of Z and Y can be represented by a path in a trellis. Here Z1, Z2, and Y1 are binary variables, while Y2 is ternary.  
</center>
...
Figure 5. A log domain factor graph for linear structured models, which include conditional random fields, support vector Markov models, and maximum margin Markov network.
</center>
